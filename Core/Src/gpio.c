...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, BEEP_Pin|LED_0_Pin|LED_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BEEP_Pin LED_0_Pin LED_1_Pin */
  GPIO_InitStruct.Pin = BEEP_Pin|LED_0_Pin|LED_1_Pin;
